...
%,~\emph{i.e.,} the flow-guided edge warping loss and frame warping loss.
...
\begin{figure}[t]
	\centering
	\includegraphics[width=1.01\columnwidth]{pipeline} % Reduce the figure size so that it is slightly narrower than the column. Don't use precise values for figure width.This setup will avoid overfull boxes. 
